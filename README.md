...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gehb-m4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gehb-m4.containers.anotherwebservice.com/
...
```
git clone git@github.com:aaduo01/container-gehb-m4.git
cd container-gehb-m4
```
...
```
docker attach container-gehb-m4
```
